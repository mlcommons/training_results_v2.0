...
if __name__ == '__main__':
    ...
    input_ids = np.zeros(
        [args.num_examples_to_pick, max_seq_length], dtype="int16")
    input_mask = np.zeros(
        [args.num_examples_to_pick, max_seq_length], dtype="int8")
    segment_ids = np.zeros(
        [args.num_examples_to_pick, max_seq_length], dtype="int8")
    masked_lm_positions = np.zeros(
        [args.num_examples_to_pick, max_predictions_per_seq], dtype="int16")
