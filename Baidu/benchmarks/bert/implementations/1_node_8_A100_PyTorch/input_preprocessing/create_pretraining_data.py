...
def write_instance_to_example_files(instances, tokenizer, max_seq_length,
    ...
    expected_instances_per_file = len(instances) // len(
        output_files) + 500  # Over-allocation to avoid resizing 
