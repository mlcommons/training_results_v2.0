...
Our NGC PyTorch codes are mostly from the NGC PyTorch codes submitted in MLPerf Training 1.1. Some differences are:

- We add the weight initialization logs in the codes according to the MLPerf Training 2.0 rules.
- We use NGC PyTorch 22.04 image to run the tests instead of NGC PyTorch 21.09 used in MLPerf Training 1.1.
