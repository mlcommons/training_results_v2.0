...
## Run specific params
export DATADIR="/dataset/datasets/rnnt/dataset" #"/raid/datasets/rnnt/"
export METADATA_DIR="/dataset/datasets/rnnt/tokenized" #"/lustre/fsw/mlperf-ci/tokenized/"
export SENTENCEPIECES_DIR="/dataset/datasets/rnnt/sentencepieces" #"/lustre/fsw/mlperf-ci/sentpiece"
