...
try:
    import apex
    from maskrcnn_benchmark.layers.bottleneck import Bottleneck as FastBottleneck
...
try:
    import apex
    from maskrcnn_benchmark.layers.bottleneck import SpatialBottleneck as SpatialBottleneck
