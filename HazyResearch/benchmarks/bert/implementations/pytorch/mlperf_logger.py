...
# def mlperf_submission_log(benchmark, logdir, logfile):

#     log_path = Path(__file__).parent.absolute() / 'logs' / logdir
#     log_path.mkdir(parents=True, exist_ok=True)
#     mllog.config(filename=str(log_path / f'result_{logfile}.txt'))
    mllogger = mllog.get_mllogger()
    ...
    if (get_rank() == 0):
        ...
        log_event(
            ...
            value=f'Azure ND96amsr_A100_v4')
