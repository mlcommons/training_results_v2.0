...
from mask_rcnn import fpn
from mask_rcnn import losses
from mask_rcnn import lr_policy
from mask_rcnn import mask_rcnn_architecture
from mask_rcnn import mask_rcnn_params
from mask_rcnn import post_processing
...
class MaskRcnnModelFn(object):
  ...
  def __init__(self, params, mllogger):
    self.params = params
    ...
    if not is_training:
      ...
      (class_outputs,
       box_outputs, box_rois) = mask_rcnn_architecture.faster_rcnn(
           ...
           features['image_info'], is_training, self.params, None,
           self.mllogger)
      ...
      mask_outputs = mask_rcnn_architecture.mask_rcnn(
          fpn_feats, is_training, self.params, detections=detections, mllogger=self.mllogger)
