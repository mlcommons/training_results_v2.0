...
**************************************************************************/
#ifndef THIRD_PARTY_PY_PYCOCOTOOLS_MASKAPI_H_
#define THIRD_PARTY_PY_PYCOCOTOOLS_MASKAPI_H_
...
/* Encode spatially local binary masks, quickly, using RLE. */
void rleEncodeSpatialBinary(RLE *R, const byte *mask, siz h, siz w);
...
#endif  // THIRD_PARTY_PY_PYCOCOTOOLS_MASKAPI_H_
