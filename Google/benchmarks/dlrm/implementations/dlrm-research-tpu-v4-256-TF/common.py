...
def get_params() -> Dict[str, Any]:
  ...
  params["selected_tables_on_ec"] = [
      int(x) for x in FLAGS.selected_tables_on_ec
  ]
  ...
  if params["selected_tables_on_ec"]:
    params["num_tables_in_ec"] = len(params["selected_tables_on_ec"])
  else:
    params["selected_tables_on_ec"] = list(range(params["num_tables_in_ec"]))
  return params
...
def define_dlrm_flags() -> None:
  ...
  flags.DEFINE_integer(
      ...
      default=26,
      help=flags_core.help_wrap(
          "Number of embedding tables in the embedding core. If "
          "selected_tables_on_ec is defined, this flag is ignored."))
  flags.DEFINE_list(
      name="selected_tables_on_ec",
      default="",
      help=flags_core.help_wrap(
          "If this flag is defined, it allows for manual placement of tables "
          "on the embedding core.  Tables are indexed from largest to "
          "smallest. For example, table index 0 has the largest vocab size, "
          "index 25 has the smallest. If defined, this flag voids any value "
          "supplied by num_tables_in_ec."))
