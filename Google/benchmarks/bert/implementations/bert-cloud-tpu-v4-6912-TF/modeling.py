...
class BertModel(object):
  ...
  def __init__(self,
    ...
    Args:
      ...
      mllogger: MLPerf logger to print weight initialization logs.
    ...
    with tf.variable_scope(scope, default_name="bert", reuse=tf.AUTO_REUSE):
      with tf.variable_scope("embeddings"):
        ...
        _log_weight_init(mllogger, "bert/embeddings/word_embeddings")
        ...
        _log_weight_init(mllogger, "bert/embeddings/position_embeddings")
        _log_weight_init(mllogger, "bert/embeddings/token_type_embeddings")
        _log_weight_init(mllogger, "bert/embeddings/LayerNorm/gamma")
        _log_weight_init(mllogger, "bert/embeddings/LayerNorm/beta")
      ...
      with tf.variable_scope(
        ...
        _log_weight_init(mllogger, "bert/pooler/dense/kernel")
        _log_weight_init(mllogger, "bert/pooler/dense/bias")
...
def attention_layer(from_tensor,
  ...
  query_layer = dense_layer_3d(
      ...
      name="query")
  _log_weight_init(
      mllogger, f"bert/encoder/layer_{layer_idx}/attention/self/query/kernel")
  _log_weight_init(mllogger,
                   f"bert/encoder/layer_{layer_idx}/attention/self/query/bias")
  ...
  _log_weight_init(
      mllogger, f"bert/encoder/layer_{layer_idx}/attention/self/key/kernel")
  _log_weight_init(
      mllogger, f"bert/encoder/layer_{layer_idx}/attention/self/key/bias")
  ...
  _log_weight_init(
      mllogger, f"bert/encoder/layer_{layer_idx}/attention/self/value/kernel")
  _log_weight_init(
      mllogger, f"bert/encoder/layer_{layer_idx}/attention/self/value/bias")
    ...
    with tf.variable_scope("layer_common", reuse=tf.AUTO_REUSE):
      ...
      with tf.variable_scope("attention"):
        ...
        with tf.variable_scope("output"):
          ...
          _log_weight_init(
              mllogger,
              f"bert/encoder/layer_{layer_idx}/attention/output/dense/kernel")
          _log_weight_init(
              mllogger,
              f"bert/encoder/layer_{layer_idx}/attention/output/dense/bias")
          attention_output = dropout(attention_output, hidden_dropout_prob)
          attention_output = layer_norm(attention_output + layer_input,
                                        layer_idx, num_hidden_layers)
          _log_weight_init(
              mllogger,
              f"bert/encoder/layer_{layer_idx}/attention/output/LayerNorm/gamma"
          )
          _log_weight_init(
              mllogger,
              f"bert/encoder/layer_{layer_idx}/attention/output/LayerNorm/beta"
          )
      ...
      with tf.variable_scope("intermediate"):
        ...
        _log_weight_init(
            mllogger,
            f"bert/encoder/layer_{layer_idx}/intermediate/dense/kernel")
        _log_weight_init(
            mllogger,
            f"bert/encoder/layer_{layer_idx}/intermediate/dense/bias")
      ...
      with tf.variable_scope("output"):
        ...
        _log_weight_init(
            mllogger,
            f"bert/encoder/layer_{layer_idx}/output/dense/kernel")
        _log_weight_init(
            mllogger,
            f"bert/encoder/layer_{layer_idx}/output/dense/bias")
        layer_output = dropout(layer_output, hidden_dropout_prob)
        layer_output = layer_norm(layer_output + attention_output, layer_idx,
                                  num_hidden_layers)
        _log_weight_init(
            mllogger, f"bert/encoder/layer_{layer_idx}/output/LayerNorm/gamma")
        _log_weight_init(
            mllogger,
            f"bert/encoder/layer_{layer_idx}/output/LayerNorm/beta"
        )                                  
