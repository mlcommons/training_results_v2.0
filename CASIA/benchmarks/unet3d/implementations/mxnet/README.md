...
### XIANGXUE-3B_A100-PCIE-40GB_7773X (single node)

Launch configuration and system-specific hyperparameters for the appropriate single node submission on XIANGXUE is in the `config_XIANGXUE-3B_A100-PCIE-40GBx16.sh`script.
...
```
source config_XIANGXUE-3B_A100-PCIE-40GBx16.sh # or any other config
