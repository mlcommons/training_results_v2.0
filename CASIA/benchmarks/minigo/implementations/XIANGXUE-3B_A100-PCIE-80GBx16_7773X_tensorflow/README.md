...
# 2. Directions
### Steps to launch training for CASIA XIANGXUE-3B_A100-PCIE-80GBx16_7773X 
...
### Run benchmark with docker for CASIA XIANGXUE-3B_A100-PCIE-80GBx16_7773X
```
    # nvidia-docker: Note that performance or functionality may vary from the tested SLURM instructions
    # Launch configuration and system-specific hyperparameters for various system  are in config_XIANGXUE-3B_A100-PCIE-80GBx16.sh. 
...
### Run benchmark with SLURM for CASIA XIANGXUE-3B_A100-PCIE-80GBx16_7773X
```
