...
export MODEL_DIR=/localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF
...
TRAIN=" poprun \
    ...
    --mlperf-log-path results/ipu-POD64-popart/rnnt/result_x.txt "
...
eval $EVAL
mv results/ipu-POD64-popart/rnnt/result_x.txt results/ipu-POD64-popart/rnnt/result_0.txt
mv /localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF /localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF_0
echo "Running Transformer-Transducer training:"
eval $TRAIN
echo "Running Transformer-Transducer evaluation:"
eval $EVAL
mv results/ipu-POD64-popart/rnnt/result_x.txt results/ipu-POD64-popart/rnnt/result_1.txt
mv /localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF /localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF_1
echo "Running Transformer-Transducer training:"
eval $TRAIN
echo "Running Transformer-Transducer evaluation:"
eval $EVAL
mv results/ipu-POD64-popart/rnnt/result_x.txt results/ipu-POD64-popart/rnnt/result_2.txt
mv /localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF /localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF_2
echo "Running Transformer-Transducer training:"
eval $TRAIN
echo "Running Transformer-Transducer evaluation:"
eval $EVAL
mv results/ipu-POD64-popart/rnnt/result_x.txt results/ipu-POD64-popart/rnnt/result_3.txt
mv /localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF /localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF_3
echo "Running Transformer-Transducer training:"
eval $TRAIN
echo "Running Transformer-Transducer evaluation:"
eval $EVAL
mv results/ipu-POD64-popart/rnnt/result_x.txt results/ipu-POD64-popart/rnnt/result_4.txt
mv /localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF /localdata/TRANSFORMER_TRANSDUCER_CHECKPOINTS_MLPERF_4
