...
## Run specific params
export DATADIR="/dataset/rnnt-dataset/data"
export METADATA_DIR="/dataset/rnnt-dataset/metadata"
export SENTENCEPIECES_DIR="/dataset/rnnt-dataset/sentencepieces"
