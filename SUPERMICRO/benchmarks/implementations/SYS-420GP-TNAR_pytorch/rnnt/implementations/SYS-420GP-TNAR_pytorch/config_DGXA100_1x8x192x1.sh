...
## Run specific params
export DATADIR="/datasets/share/rnnt/datasets/"
export METADATA_DIR="/datasets/share/rnnt/datasets/metadata/"
export SENTENCEPIECES_DIR="/datasets/share/rnnt/datasets/sentencepieces/"
