...
* for the 128-node with packed data NVIDIA DGX A100 submission: `config_DGXA100_128x8x2x1_pack.sh`
...
128-node packed data NVIDIA DGX A100 training:

```
source config_DGXA100_128x8x2x1_pack.sh
