...
export EXTRA_PARAMS="--unpad --unpad_fmha --use_split_data --split_batch_cnt 6 3 2 5 --group_exchange_padding --ngpus_per_group=8  --reverse_indices --local_gradient_clip --use_partial_data --log_freq 0 --lr_max_steps 179 --fused_gelu_bias --fused_bias_fc --fused_bias_mha --fused_dropout_add --fused_bias_fc_loss_head"

export INPUT_DIR='/local_scratch/ci2015.choi/bert_v1.0/partial_data/4bin_1024gpu'
