...
python /tmp/create_ffcv_datasets.py --dataset $BENCHMARK_DATASET --split train --datadir $DATADIR
python /tmp/create_ffcv_datasets.py --dataset $BENCHMARK_DATASET --split val --datadir $DATADIR
